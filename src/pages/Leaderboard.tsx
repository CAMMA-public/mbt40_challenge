            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  The leaderboard will be available after the challenge submissions are evaluated. Results will be first presented at the Endoscopic Vision Challenge meeting at MICCAI 2026 on <strong className="text-foreground">October 4, 2026</strong> at ADNEC Centre, Abu Dhabi.
                </p>
                <p className="text-muted-foreground">
